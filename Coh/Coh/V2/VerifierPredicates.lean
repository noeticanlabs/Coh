...
def LengthBound (S : System) (A : Assumptions S) (V : X → ℝ)
...
def CostBound (S : System) (A : Assumptions S) (V : X → ℝ)
    (f : CertifiedMor S A V x y) (C : ℝ) : Prop :=
  f.defect ≤ C
...
theorem cost_bound_comp
    (S : System) (A : Assumptions S) (V : X → ℝ)
    {x y z : X}
